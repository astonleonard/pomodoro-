...
YELLOW = "#f7f5dd"
FONT_NAME = "Courier"
WORK_MIN = int(input("How manny minutes you work?: "))
SHORT_BREAK_MIN = int(input("How manny minutes your short break?: "))
LONG_BREAK_MIN = int(input("How manny minutes your long break?: "))
reps = 0
timer = ""
...
timer_text = canvas.create_text(100, 130, text="00:00:00", fill="white", font=(FONT_NAME, 30, "bold"))
